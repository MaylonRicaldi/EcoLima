...
graph TD
    ...
    UserAdmin -->|"Administra configuración"| System
    UserOperador -->|"Gestiona pedidos y despachos"| System
    UserConductor -->|"Consulta rutas y actualiza entregas"| System
    UserAuditor -->|"Consulta información"| System
    UserCliente -->|"Recibe ETA y alertas"| System
...
graph TD
    ...
    K8s["K8s Cluster<br/>sa-east-1 (São Paulo)"]

    PodWA["Pod React<br/>3 réplicas"]
    PodAPI["Pod FastAPI<br/>HPA 3-20"]
    PodWorker["Pod Celery Worker<br/>HPA 2-10"]
    PodRedis["Redis Sentinel"]
    PodDB[("PostgreSQL Primary<br/>+ Replica")]
    Storage["S3 Bucket"]
