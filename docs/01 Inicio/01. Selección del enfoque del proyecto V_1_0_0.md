...
| Campo | Detalle |
|---|---|
| **Nombre del Proyecto** | EcoLima – Optimizador de Rutas Sostenibles para DistriRápido S.A.C. |
...
**Ubicación en el repositorio:** `docs/01 Inicio/01. Selección del enfoque del proyecto V_1_0_0.md`
